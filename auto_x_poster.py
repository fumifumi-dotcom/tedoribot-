...
以下の【今日の最新トレンド】と【年収データ】を自然に結びつけて、見た人が思わず「ヤバい」とブックマークしてしまうX（Twitter）の投稿本文（140文字程度）を1つだけ作成してください。
...
・【超重要】スマホで見た時に文字が詰まって見えないよう、適度な「空行（1行空け）」を入れて段落を美しく整理してください。
...
"""
    ...
    if not main_text:
        main_text = f"いま世間は『{trend_kw}』の話題で持ちきりですが…\n\nそれより年収{data['income']}万円のあなたが\n【年間{data['tax_total']}万円】も国に奪われている事実の方が大問題です。\n\n手取りなんてたった{data['tedori']}万円。\n\n現実に絶望したい人はプロフ見て。"
